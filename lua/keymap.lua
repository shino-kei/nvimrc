...
-- ビジュアルモードでペーストしても無名レジスタを書き換えないように設定 --
keymap('x', 'p', 'P', opts)
...
if executable('atcoder-tools')
  command! AtcoderTest !g++ -std=gnu++20 -Wall -Wextra -Wno-unused-result -O2 main.cpp -I /Users/keisuke/workspace/atcoder/ac-library && atcoder-tools test
  command! AtcoderDebug !g++ -std=gnu++20 -Wall -Wextra -Wno-unused-result -DLOCAL -O0 -g3 main.cpp && atcoder-tools test
